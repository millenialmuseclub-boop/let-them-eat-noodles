...
Status: drafted, ready for Play Console entry once an app record exists. Not yet submitted anywhere.

## App Name
Let Them Eat Noodles

## Short Description (80 char max)
A global noodle encyclopedia, atlas, cooking studio, and craving-matcher.
...
No restaurant reviews, no ratings, no reservations — just the noodle.

## Category
Food & Drink

## Tags
noodles, ramen, pho, pad thai, pancit, udon, soba, japchae, laksa, asian cooking, recipes, culinary reference

## Content Rating Guidance
Everyone / PEGI 3 equivalent. No violence, no user-generated content, no in-app purchases, no ads within the app itself (outbound affiliate links only, opened externally).

## Data Safety Section Notes (for Play Console's Data Safety form)
- **Data collected: none transmitted off-device.** The app's own code stores only a local personal library (want-to-try / tried / favorite dish lists) in on-device storage; this is never uploaded, synced, or shared.
- **No account creation, no login, no personal identifiers collected.**
- **Third-party links**: the Curated Kitchen section and some Workshop lessons contain outbound affiliate links to external merchant websites (ShopMy, LTK, and similar), which open in the system browser. Google Play's Data Safety form should reflect that the app does not itself collect data, but disclose that tapping these links leaves the app and is subject to the destination site's own data practices — standard for any app containing outbound links.
